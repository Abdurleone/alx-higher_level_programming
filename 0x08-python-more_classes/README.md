...
* [tests](./tests): Folder of test files. Provided by ALX SE program.
...
* **10. N Queens**
  ...
  * Solutions are printed one per line in the format `[[r, c], [r, c], [r, c], [r, c]]` where `r` and `c` represent the row and column, respectively, where a queen must be placed.n - More Classes and Objects
